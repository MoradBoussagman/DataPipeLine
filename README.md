...
│                       Airflow Scheduler                              │
│           - Monitors DAGs                                            │
│           - Triggers Spark jobs and training tasks                   │
...
│ (localhost:5432)│  │  (localhost:8081)   │   │   (localhost:9093)   │
│                │   │  - Job Scheduling   │   │  - KRaft Mode        │
│ - Airflow DB   │   │  - Resource Mgmt    │   │  - raw_data          │
│ - Pipeline DB  │   │  - Worker Coord.    │   │  - processed_data    │
│ - MLflow DB    │   └──────────┬──────────┘   │  - anomalies         │
└───────┬────────┘              │              └──────────┬───────────┘
        │                       ▼                         │
        │           ┌───────────────────────┐             │
        │           │    Spark Worker(s)    │◄────────────┘
        │           │  - Execute Tasks      │   Consume / produce
        │           │  - Process Streams    │
        │           │  - Write Results      │
        │           └───────────┬───────────┘
        │                       │
...
│ - Experiment runs    │             │ - Dashboards         │
│ - Model registry     │             │ - Analytics          │
│ - Production alias   │             │ - SQL exploration    │
└──────────┬───────────┘             └──────────────────────┘
           │
           ▼
┌──────────────────────┐
